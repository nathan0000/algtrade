...
def usHolidays(a=datetime.date.today(), b=datetime.date.today()+datetime.timedelta(days=365)):
    rs = rrule.rruleset()
...
def usTradingdays(a=datetime.date.today(), b=datetime.date.today()+datetime.timedelta(days=365)):
    rs = rrule.rruleset()
...
def getDate():
    ...
    usTradingDay = list(usTradingdays())
    return today, todaytime, usTradingDay[0].strftime("%Y%m%d")
