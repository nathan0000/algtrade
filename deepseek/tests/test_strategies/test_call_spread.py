...
class TestCallCreditSpreadStrategy:
    ...
    def test_initialization(self, mock_ibkr_client):
        ...
        strategy = CallCreditSpreadStrategy(mock_ibkr_client, strategy_config, risk_config)
    ...
    def test_should_enter_optimal_conditions(self, mock_ibkr_client,
        ...
        sample_first_hour['market_type'] = 'trending_bearish'   # string, not enum
    ...
    def test_should_enter_blocked_by_sentiment(self, mock_ibkr_client,
                                                sample_market_state, sample_vix_state,
                                                sample_sentiment, sample_first_hour):
    ...
    def test_should_enter_bullish_market(self, mock_ibkr_client,
                                          sample_market_state, sample_vix_state,
                                          sample_sentiment, sample_first_hour):
    ...
    def test_should_enter_above_vwap(self, mock_ibkr_client,
                                      sample_market_state, sample_vix_state,
                                      sample_sentiment, sample_first_hour):
    ...
    def test_gap_up_confidence_boost(self, mock_ibkr_client,
                                      sample_market_state, sample_vix_state,
                                      sample_sentiment, sample_first_hour):
